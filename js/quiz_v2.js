document.addEventListener('DOMContentLoaded', () => {
  ...
  const backBtn = document.getElementById('modalQuizBackBtn');
  const progressBar = document.getElementById('modalQuizProgressBar');
  const currentStepSpan = document.getElementById('modalQuizCurrentStep');
  const form = document.getElementById('modalQuizForm');
  const quizBodyView = document.getElementById('modalQuizBodyView');
  const quizSuccessView = document.getElementById('modalQuizSuccessView');
  const submitBtn = document.getElementById('modalQuizSubmitBtn');
  ...
  const nameInput = document.getElementById('modalQuizName');
  const phoneInput = document.getElementById('modalQuizPhone');
  const consentBox = document.getElementById('modalQuizConsent');
